...
const projects = [
  ...
  longDescription:
    'Built a full-stack application featuring role-based dashboards, real-time booking system, and integrated payment processing. Implemented responsive design and optimized for mobile-first experience.',
  ...
  live: 'https://smart-service-hub-local-service-boo.vercel.app/',
...

  {
    ...
    link: '#',
    github: 'https://github.com/ShreyashS19/bank-churn-prediction.git',
    showLinks: true,
  },
  {
    id: 3,
        ...
        <DialogContent className="glass border-border max-w-3xl max-h-[90vh] overflow-y-auto">
          {selectedProject && (
            <>
             ...
             {selectedProject.showLinks && (
  <div className="flex flex-wrap gap-4 mt-6">
    {/* Live Demo – ONLY if live exists */}
    {selectedProject.live && (
      <motion.a
        href={selectedProject.live}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-semibold hover:opacity-90 transition-all"
    ...
    {/* GitHub – shown wherever github exists */}
