...
import { MapPin, Briefcase, GraduationCap, Sparkles, FolderGit2  } from 'lucide-react';
//import { MapPin, GraduationCap, Sparkles, FolderGit2 } from 'lucide-react';

const highlights = [
  { icon: FolderGit2, label: 'Projects', value: '8+ Projects Completed' },
