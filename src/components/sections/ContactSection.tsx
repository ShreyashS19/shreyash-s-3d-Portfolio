...
const socialLinks = [
  {
    icon: SiGithub,
    label: 'GitHub',
    href: 'https://github.com/ShreyashS19',
    color: 'hover:text-foreground',
  },
  {
    icon: SiLinkedin,
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/shreyash-shinde19/',
    color: 'hover:text-primary',
  },
  {
    icon: Mail,
    label: 'Email',
    href: 'https://mail.google.com/mail/?view=cm&fs=1&to=shindeshreyash363@gmail.com&su=Hello%20from%20Portfolio',
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          <p className="text-muted-foreground text-sm">
  © {new Date().getFullYear()} Shreyash Shinde • 
  <span className="hover:text-accent transition-colors"> Built with purpose </span> 
  and far too much ☕
</p>
        </motion.footer>
      </div>
